...
import { BookOpen, Calendar, ArrowRight, Zap, Target, Users, Shield, LayoutGrid } from 'lucide-react';
...
export default function WelcomeView({ onSelectGeneral, onSelectMonth }: WelcomeViewProps) {
      ...
      <div className="max-w-5xl mx-auto px-8 pt-16 pb-24 relative z-10">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 mb-4">
            <span className="w-8 h-px bg-brand-red/30" />
            <h2 className="text-[10px] font-black text-brand-red uppercase tracking-[0.4em]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <button 
              ...
              className="group block w-full text-left bg-white border border-slate-200 rounded-3xl p-8 transition-all hover:border-slate-900 hover:shadow-xl hover:shadow-slate-200/50 h-full"
            >
              <div className="flex flex-col h-full">
                ...
                <div className="mb-4">
                  ...
                  <h3 className="text-xl font-black text-slate-900 mt-1">Directrices Permanentes</h3>
                </div>
                <p className="text-slate-500 text-xs font-medium leading-relaxed mb-8 flex-1">
                  Modelado inamovible de la campaña. Criptografía táctica y blindaje.
                </p>
